...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 36.0, 185.0, 128.0, 128.0 ],
					"varname" : "BPATCHERNAME",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 198.0, 185.0, 156.0, 47.0 ],
					"text" : "rename BPATCHERNAME with your actual bpatcher name"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 36.0, 111.0, 238.0, 20.0 ],
					"text" : "script sendbox BPATCHERNAME hidden $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 36.0, 140.148560000000003, 100.0, 22.0 ],
